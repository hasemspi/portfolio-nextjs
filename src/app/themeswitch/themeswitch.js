...
<label className="swap swap-rotate">
  ...
  {/* Sun Icon */}
  <svg
    className="swap-on h-10 w-10 fill-current text-yellow-500" // Sun icon for light mode
  ...
  {/* Moon Icon */}
  <svg
    className="swap-off h-10 w-10 fill-current text-blue-500" // Moon icon for dark mode
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
  >
    <path
