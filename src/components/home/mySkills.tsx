const MySkillsPage = () => {
    const skills = [
        {
            id: 1, name: "Figma", percentage: 92, icon: (
        ...
        {
            id: 3, name: "CSS3", percentage: 85, icon: (
                <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
        ...
        {
            id: 4, name: "WordPress", percentage: 99, icon: (
        ...
        {
            id: 5, name: "React", percentage: 89, icon: (
        ...
        {
            id: 6, name: "JavaScript", percentage: 93, icon: (
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 64 64">
        ...
        {
            id: 7, name: "PHP", percentage: 93, icon: (
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 64 64">
        ...
        {
            id: 8, name: "DATABASE", percentage: 93, icon: (
                <svg
                height="24" // Adjust height as needed
                width="24" // Adjust width as needed
        ...
        {
            id: 8, name: "Prisma", percentage: 93, icon: (
            <svg
                width="24"
                height="24"
                viewBox="0 0 32 32"
